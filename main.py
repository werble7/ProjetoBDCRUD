...
== == == =
            print(("+" + "-" * 40) * 5 + "+")
            print("| idArbitro" + " "*30 + "| nome" + " "*35 + "| data de nascimento" +
                  " "*21 + "| qtd de jogos" + " "*27 + "| data de Estreia" + " "*24 + "|")
            for linha in result:
                print(("+" + "-" * 40) * 5 + "+")
                print("| " + str(linha[0]) + " " *
                      (39-len(str(linha[0]))), end="")
...
== == == =
            print(("+" + "-" * 40) * 5 + "+")
            print("| idEstadio" + " " * 30 + "| nome" + " " * 35 + "| data de inauguração" +
                  " "*20 + "| valor" + " " * 34 + "| capacidade" + ' '*29 + "|")
            for linha in result:
                print(("+" + "-" * 40) * 5 + "+")
                print("| " + str(linha[0]) + " " *
                      (39 - len(str(linha[0]))), end="")
