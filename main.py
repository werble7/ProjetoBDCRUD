...
def telaCreate():
    while True:
        ...
        if opcao == 1:
            ...
            qtdJogos = input()
            dataEstreia = input()
            comando = f"insert into Tecnico(nome, dataNasc, qtdJogos, dataEstreia) values('{nome}', '{dataNasc}', {qtdJogos}, '{dataEstreia}')"
            cursor.execute(comando)
            connection.commit()
        elif opcao == 6:
            print("Digite a informação do clube")
            desc = input()
            comando = f"insert into Clube(descricao) values('{desc}')"
            cursor.execute(comando)
            connection.commit()
        elif opcao == 7:
            print("Digite informações do jogador")
            desc = input()
            comando = f"insert into Jogador(descricao) values('{desc}')"
            cursor.execute(comando)
            connection.commit()
        elif opcao == 8:
            print("Digite a lesão do jogador")
            desc = input()
            comando = f"insert into LesaoJogador(descricao) values('{desc}')"
            cursor.execute(comando)
            connection.commit()
        elif opcao == 9:
            print("Digite informações do jogo")
            desc = input()
            comando = f"insert into Jogo(descricao) values('{desc}')"
            cursor.execute(comando)
            connection.commit()
        elif opcao == 10:
            print("Digite o CartaoJogador")
            desc = input()
            comando = f"insert into CartaoJogador(descricao) values('{desc}')"
            cursor.execute(comando)
            connection.commit()
        elif opcao == 11:
            print("Digite informacoes do cartao tecnico")
            desc = input()
            comando = f"insert into CartaoTecnico(descricao) values('{desc}')"
            cursor.execute(comando)
            connection.commit()
        elif opcao == 12:
            print("Digite ingformacoes do Titulo")
            desc = input()
            comando = f"insert into Titulo(descricao) values('{desc}')"
            cursor.execute(comando)
            connection.commit()
...
<<<<<<< HEAD
            ...
            for linha in result:
                print(("+" + "-" * 20) * 5 + "+")
                print("| " + str(linha[0]) + " " *
                      (19-len(str(linha[0]))), end="")
                print("| " + str(linha[1]) + " " *
                      (19 - len(str(linha[1]))), end="")
                print("| " + str(linha[2]) + " " *
                      (19 - len(str(linha[2]))), end="")
                print("| " + str(linha[3]) + " " *
                      (19 - len(str(linha[3]))), end="")
                print("| " + str(linha[4]) + " " *
                      (19 - len(str(linha[4]))) + "|")
            print(("+" + "-" * 20) * 5 + "+")
=======
            print(("+" + "-" * 40) * 5 + "+")
            print("| idArbitro" + " "*30 + "| nome" + " "*35 + "| data de nascimento" + " "*21 + "| qtd de jogos" + " "*27 + "| data de Estreia" + " "*24 + "|")
            for linha in result:
                print(("+" + "-" * 40) * 5 + "+")
            ...
            print(("+" + "-" * 40) * 5 + "+")
>>>>>>> e1b72e15d8aca537f0ceed772cbb3210b59fe741
        if opcao == 2:
...
=======
            print(("+" + "-" * 40) * 5 + "+")
            print("| idEstadio" + " " * 30 + "| nome" + " " * 35 + "| data de inauguração" + " "*20 + "| valor" + " " * 34 + "| capacidade" + ' '*29 + "|")
            for linha in result:
                print(("+" + "-" * 40) * 5 + "+")
                print("| " + str(linha[0]) + " " * (39 - len(str(linha[0]))), end="")
                print("| " + str(linha[1]) + " " * (39 - len(str(linha[1]))), end="")
...
=======
                print(("+" + "-" * 40) * 2 + "+")
                print("| " + str(linha[0]) + " " * (39 - len(str(linha[0]))), end="")
                print("| " + str(linha[1]) + " " * (39 - len(str(linha[1]))) + "|")
            print(("+" + "-" * 40) * 2 + "+")
>>>>>>> e1b72e15d8aca537f0ceed772cbb3210b59fe741
        if opcao == 4:
...
>>>>>>> e1b72e15d8aca537f0ceed772cbb3210b59fe741
        ...
        if opcao == 7:
            ...
            result = cursor.fetchall()
            print(("+" + "-" * 20) * 8 + "+")
            print("| idJogador" + " "*10 + "| nome" + " "*15 +
                  "| data de nascimento " + "| posicao" + " "*12, end="")
            print("| qtd de jogos" + ' '*7 + "| qtd de gols" + " "*8 +
                  "| qtd de assists" + " "*5 + "| idClube" + " "*12 + "|")
            for linha in result:
                print(("+" + "-" * 20) * 8 + "+")
<<<<<<< HEAD
                print("| " + str(linha[0]) + " " *
                ...
                print("| " + str(linha[3]) + " " *
                      (19 - len(str(linha[3]))), end="")
                print("| " + str(linha[4]) + " " *
                      (19 - len(str(linha[4]))), end="")
                print("| " + str(linha[5]) + " " *
                      (19 - len(str(linha[5]))), end="")
                print("| " + str(linha[6]) + " " *
                      (19 - len(str(linha[6]))), end="")
                print("| " + str(linha[7]) + " " *
                      (19 - len(str(linha[7]))) + "|")
